...
tfds build $DATASET_CONFIG \
  ...
  --beam_pipeline_options="runner=DataflowRunner,project=$GCP_PROJECT,job_name=$DATASET_NAME-gen-mini,staging_location=$GCS_BUCKET/binaries,temp_location=$GCS_BUCKET/temp,region=$REGION,setup_file=$TEMP/setup.py,machine_type=n1-highmem-32,num_workers=5"
