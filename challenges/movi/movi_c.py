...
class MoviCConfig(tfds.core.BuilderConfig):
...
class MoviC(tfds.core.BeamBasedBuilder):
  """DatasetBuilder for MOVi-C dataset."""
  ...
  BUILDER_CONFIGS = [
      MoviCConfig(
          ...
          train_val_path="gs://research-brain-kubric-xgcp/jobs/movi_c_regen3_10k/",
          test_split_paths={
              "test": "gs://research-brain-kubric-xgcp/jobs/movi_c_test_regen_1k/",
          }
      ),
      MoviCConfig(
          name="128x128",
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    def get_movi_c_instance_features(seq_length: int):
    ...
    return tfds.core.DatasetInfo(
        ...
        features=tfds.features.FeaturesDict({
            ...
            "instances": tfds.features.Sequence(
                feature=get_movi_c_instance_features(seq_length=s)),
  ...
  def _generate_examples(self, directories: List[str]):
    ...
    def _process_example(video_dir):
      ...
      # add MOVid-C specific instance information:
